...
/**
 * Die Klasse Eingabeformular stellt alle Eigenschaften und 
 * Methoden des Eingabeformulars (inkl. HMTL und Events) zur Verfügung.
 */
export default class Eingabeformular {
    ...
    * @returns - einfaches Objekt mit den verarbeiteten Formulardaten
    */
    _formulardaten_verarbeiten(formulardaten) {
        ...
        return {
            ...
            betrag: parseInt(formulardaten.betrag) * 100,
    ...
    _formulardaten_validieren(formulardaten) {
        ...
        if (formulardaten.typ === undefined || formulardaten.typ === null) {
            fehler.push("Typ")
        }
     ...
     */
    _absenden_event_hinzufügen(formular) {
        ...
        <form id="eingabeformular" action="#" method="get"></form> 
            ...
            <div class="eingabeformular-zeile">
                <div class="betrag-datum-eingabe-gruppe">
                    ...
                    <input type="date" id="datum" name="datum" form="eingabeformular" size="10" required>
                </div>
            </div>
            <div class="eingabeformular-zeile">
